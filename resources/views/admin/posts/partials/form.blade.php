...
<div class="row mb-3">
  <div class="col">
      <div class="image-wraper">
        ...
        @else
        <img id="picture" src="https://cdn.pixabay.com/photo/2021/02/06/07/02/laptop-5987093_960_720.jpg">
        @endif          
      </div>
  </div>
  <div class="col">
      <div class="form-group">
          ...
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Earum, excepturi!
          @error('file')
          <small class="text-danger">{{$message}}</small>
          @enderror
      </div>
