<nav class="bg-gray-800" x-data="{open: false}">
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
      <div class="relative flex items-center justify-between h-16">
          <!-- Mobile menu button-->
        <div class="absolute inset-y-0 left-0 flex items-center sm:hidden" x-show="{open}">
        ...
        <div class="flex-1 flex items-cente justify-center sm:items-stretch sm:justify-start">
            {{-- Logotipo --}}
