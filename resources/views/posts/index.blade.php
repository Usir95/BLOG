        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {{-- {{$post->image->url}} --}}
                <article class="w-full h-80 bg-cover bg-center @if($loop->first) md:col-span-2  @endif" 
                    style="background-image: url(@if($post->image) {{Storage::url($post->image->url)}} @else https://cdn.pixabay.com/photo/2021/02/06/07/02/laptop-5987093_960_720.jpg @endif">
